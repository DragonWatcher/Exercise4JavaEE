...
//        System.out.println("timestamp长度：" + Long.toBinaryString(timestamp - startTime).length());
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            System.out.println(Long.toBinaryString(id) + "二进制长度" + String.valueOf(Long.toBinaryString(id)).length());
